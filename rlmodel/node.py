...
class Node:
    def __init__(self, name: str, metrics : dict = None):
        ...
        if metrics is not None:
            ...
            self.disk_read = int(random.uniform(0, 5000))
            self.disk_write = int(random.uniform(0, 5000))
    ...
    def is_valid(self) -> bool:
        ...
        if self.cpu > 0.95 or self.ram > 13000 or self.disk_read > 18000  or self.disk_write > 18000 or self.network_bandwidth > 90:
            return False
        return True
    ...
    def is_done(self) -> bool:
        ...
        if self.real_metrics['cpu'] > 95 or self.real_metrics['ram'] > 28000 or self.real_metrics['disk_read'] > 20000 \
                or self.real_metrics['disk_write'] > 20000 or self.real_metrics['network_bandwidth'] > 50:
            return True
        return False
